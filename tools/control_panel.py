...
GROUPS = [
    ...
    ("Curve", [
        ...
        ("blind_edge_frames",        "i", 1,      "edge frames before starting blind"),
        ("blind_default_dir",        "f", 1.0,    "fallback turn dir (+1 left, -1 right)"),
        ("blind_heading_min",        "f", 0.05,   "min BEV heading to trust blind side"),
        ("blind_reacquire_off",      "f", 0.05,   "|off| back at center -> stop turn"),
        ("blind_min_s",              "f", 0.1,    "min blind turn (hysteresis)"),
        ("blind_enter_frames",       "i", 1,      "lost frames before turning"),
        ("blind_conf",               "f", 0.05,   "BEV conf = line visible"),
        ("blind_lost_conf",          "f", 0.05,   "below this counts as lost"),
        ("blind_max_s",              "f", 0.5,    "blind turn safety cap"),
        ("curve_arc_enabled",        "b", 1,      "(legacy) timer arc; off when blind on"),
...
DEFAULTS = {
    "kp": 0.0018, "kd": 0.0, "ff_gain": 1.0, "max_v": 0.09, "max_w": 0.6,
    ...
    "blind_turn_enabled": True, "blind_turn_w": 0.35, "blind_turn_v": 0.05,
    "blind_conf": 0.5, "blind_lost_conf": 0.35,
    "blind_reacquire_off": 0.25, "blind_enter_frames": 3,
    "blind_enter_off": 0.65, "blind_edge_frames": 3,
    "blind_default_dir": 1.0, "blind_heading_min": 0.25,
    "blind_pre_s": 2.0, "blind_min_s": 0.3, "blind_side_w_min": 0.015,
    "blind_max_s": 3.0,
