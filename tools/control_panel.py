...
GROUPS = [
    ...
    ("Intersection", [
        ...
        ("read_distance_cm",         "f", 1.0,    "stop-to-read dist to entry (tune)"),
        ("advance_center_gain",      "f", 0.01,   "ADVANCE centring gain (sign!)"),
...
DEFAULTS = {
    ...
    "approach_speed": 0.06, "commit_turn_w": 0.6, "commit_duration": 2.0, "commit_min_s": 0.8,
    "commit_duration_straight": 5.0, "commit_straight_min_s": 3.0, "align_tol_deg": 12.0,
    "detect_distance_cm": 22.0, "read_distance_cm": 4.0, "advance_center_gain": 0.03,
