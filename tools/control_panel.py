...
GROUPS = [
    ...
    ("AntiZebra", [
        ...
        ("zebra_block_in_curve",     "b", 1,      "block zebra trigger while curved"),
        ("zebra_curve_block_min_curv", "f", 0.05, "min curv to block zebra"),
        ("zebra_curve_block_hold_s", "f", 0.1,    "curve block memory"),
    ]),
    ("Warp", [
...
DEFAULTS = {
    ...
    "lane_hold_curve_s": 1.80, "lane_hold_curve_min_curv": 0.55,
    ...
    "zebra_block_in_curve": True, "zebra_curve_block_min_curv": 0.50,
    "zebra_curve_block_hold_s": 1.20,
}
