...
GROUPS = [
    ...
    ("Intersection", [
        ...
        ("commit_duration",          "f", 0.25,   "commit safety timeout"),
        ("commit_min_s",             "f", 0.1,    "min commit before reacquire"),
        ("k_align",                  "f", 0.1,    "legacy approach align gain"),
        ("approach_align_slope",     "f", 0.02,   "legacy align threshold"),
    ]),
    ("Zebra", [
